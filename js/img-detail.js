    ...
    $("#love-btn").click(function () {
        $.ajax({
            ...
            success:function (res) {
                ...
                if(res.msg === "点赞成功！"){
                    $("#love-btn").empty();
                    $("#love-btn").append("<span class=\"iconfont love\" style=\"float: none;color: darkgrey\">&#xe61a; </span>取消喜欢");
                }else if (res.msg === "取消点赞成功！"){
                    $("#love-btn").empty();
                    $("#love-btn").append("<span class=\"iconfont love\" style=\"float: none;color: red\">&#xe61a; </span>喜欢");
                }
            }
        })
    });
