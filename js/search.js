...
$(document).ready(function () {
    ...
    if(firstdata.length === 0){
        var tem = $("<div style='text-align: center;margin-top: 200px; font-size:22px; color: gray;font-family: '微软雅黑';'> 没有您搜索的图片 </div>");
        tem.appendTo($(".main"));
    }
...
function AddImg(data) {
    ...
    for(var i = 0;i<data.length;i++){
        ...
        var button = $("<a class='btn iconfont' role='button' style='color: darkgrey' >&#xe61a;</a>");
